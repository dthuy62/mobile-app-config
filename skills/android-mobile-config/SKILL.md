...
description: Configure Android mobile app project setup with deterministic scripts for product flavors, flavor-specific app names, launcher/adaptive/splash/notification assets, and optional Android network security config. Use when the user asks to add or validate dev/prod Android flavors, generate Android app icons or splash assets, create android-mobile-config.json, or configure Android network-security XML for local/dev builds.
---
